...
public class ImportExcelObjects implements IExternalJavaAction{
	
	public ImportExcelObjects() {
...
//        }
        ...
        try {
            IEolModule module = new EolModule();    
            File eolFile = new File("D:\\Workspaces\\Projects\\ESDT2\\cnsa.ee.digital.twin.example\\test149\\importObjects.eol");
            module.parse(eolFile);           
            ...
            File excelFile = new File("D:\\Workspaces\\Projects\\ESDT2\\cnsa.ee.digital.twin.example\\test149\\ImportObjects.xlsx");
            excelModel.setSpreadsheetFile(excelFile.getAbsolutePath());            
            excelModel.setConfigurationFile(null);
