...
public class ImportRealValues implements IExternalJavaAction{
	
	public ImportRealValues() {
	...
	public void execute(Collection<? extends EObject> selections, Map<String, Object> parameters) {
        ...
        try {
            ...
            File eolFile = new File("D:\\Workspaces\\Projects\\ESDT2\\cnsa.ee.digital.twin.example\\test149\\importRealValues.eol");
            ...
            try (ExcelModel excelModel = new ExcelModel()) {
				File excelFile = new File("D:\\Workspaces\\Projects\\ESDT2\\cnsa.ee.digital.twin.example\\test149\\importRealValues.xlsx");
