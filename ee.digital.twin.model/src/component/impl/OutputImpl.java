 ...
 * </p>
 * <ul>
 *   <li>{@link component.impl.OutputImpl#isFaulty <em>Faulty</em>}</li>
 *   <li>{@link component.impl.OutputImpl#isRunningNormally <em>Running Normally</em>}</li>
 *   <li>{@link component.impl.OutputImpl#isRunningAbnormally <em>Running Abnormally</em>}</li>
 *   <li>{@link component.impl.OutputImpl#isToBePredicted <em>To Be Predicted</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputImpl extends IONodeImpl implements Output {
	...
	public void setFaulty(boolean newFaulty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Component_Package.OUTPUT__FAULTY, oldFaulty, faulty));
	}
	...
	public void setRunningNormally(boolean newRunningNormally) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Component_Package.OUTPUT__RUNNING_NORMALLY, oldRunningNormally, runningNormally));
	}
	...
	public void setRunningAbnormally(boolean newRunningAbnormally) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Component_Package.OUTPUT__RUNNING_ABNORMALLY, oldRunningAbnormally, runningAbnormally));
	}
	...
	public void setToBePredicted(boolean newToBePredicted) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Component_Package.OUTPUT__TO_BE_PREDICTED, oldToBePredicted, toBePredicted));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Component_Package.OUTPUT__FAULTY:
				return isFaulty();
			case Component_Package.OUTPUT__RUNNING_NORMALLY:
				return isRunningNormally();
			case Component_Package.OUTPUT__RUNNING_ABNORMALLY:
				return isRunningAbnormally();
			case Component_Package.OUTPUT__TO_BE_PREDICTED:
