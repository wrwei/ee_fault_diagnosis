	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Artifact_Package.ARTIFACT_PACKAGE: {
				...
				if (result == null) result = caseDTElement(artifactPackage);
			...
			case Artifact_Package.ARTIFACT_PACKAGE_INTERFACE: {
				...
				if (result == null) result = caseDTElement(artifactPackageInterface);
			...
			case Artifact_Package.ARTIFACT_ASSET: {
				...
				if (result == null) result = caseDTElement(artifactAsset);
			...
			case Artifact_Package.PROPERTY: {
				...
				if (result == null) result = caseDTElement(property);
			...
			case Artifact_Package.TECHNIQUE: {
				...
				if (result == null) result = caseDTElement(technique);
			...
			case Artifact_Package.PARTICIPANT: {
				...
				if (result == null) result = caseDTElement(participant);
			...
			case Artifact_Package.ACTIVITY: {
				...
				if (result == null) result = caseDTElement(activity);
			...
			case Artifact_Package.EVENT: {
				...
				if (result == null) result = caseDTElement(event);
			...
			case Artifact_Package.RESOURCE: {
				...
				if (result == null) result = caseDTElement(resource);
			...
			case Artifact_Package.ARTIFACT: {
				...
				if (result == null) result = caseDTElement(artifact);
			...
			case Artifact_Package.ARTIFACT_ASSET_RELATIONSHIP: {
				...
				if (result == null) result = caseDTElement(artifactAssetRelationship);
