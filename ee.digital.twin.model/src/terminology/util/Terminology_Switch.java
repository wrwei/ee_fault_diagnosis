	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Terminology_Package.TERMINOLOGY_ELEMENT: {
				...
				if (result == null) result = caseDTElement(terminologyElement);
			...
			case Terminology_Package.TERMINOLOGY_GROUP: {
				...
				if (result == null) result = caseDTElement(terminologyGroup);
			...
			case Terminology_Package.TERMINOLOGY_PACKAGE: {
				...
				if (result == null) result = caseDTElement(terminologyPackage);
			...
			case Terminology_Package.TERMINOLOGY_PACKAGE_BINDING: {
				...
				if (result == null) result = caseDTElement(terminologyPackageBinding);
			...
			case Terminology_Package.TERMINOLOGY_PACKAGE_INTERFACE: {
				...
				if (result == null) result = caseDTElement(terminologyPackageInterface);
			...
			case Terminology_Package.TERMINOLOGY_ASSET: {
				...
				if (result == null) result = caseDTElement(terminologyAsset);
			...
			case Terminology_Package.CATEGORY: {
				...
				if (result == null) result = caseDTElement(category);
			...
			case Terminology_Package.EXPRESSION_ELEMENT: {
				...
				if (result == null) result = caseDTElement(expressionElement);
			...
			case Terminology_Package.EXPRESSION: {
				...
				if (result == null) result = caseDTElement(expression);
			...
			case Terminology_Package.TERM: {
				...
				if (result == null) result = caseDTElement(term);
