		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArtifactPackageInterface_interfaceOf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArtifactPackageInterface_interfaceOf_feature", "_UI_ArtifactPackageInterface_type"),
				 Artifact_Package.Literals.ARTIFACT_PACKAGE_INTERFACE__INTERFACE_OF,
				 true,
				 false,
				 true,
				 null,
