 ...
 * @generated
 */
public class ModelElementItemProvider extends DTElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Base_Package.Literals.MODEL_ELEMENT__EXTERNAL_REFERENCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Base_Package.Literals.MODEL_ELEMENT__EXTERNAL_REFERENCE,
				 Base_Factory.eINSTANCE.createExternalReference()));
	}
