	...
	protected void addFaultyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DirectedRelationship_faulty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedRelationship_faulty_feature", "_UI_DirectedRelationship_type"),
				 Component_Package.Literals.DIRECTED_RELATIONSHIP__FAULTY,
				 true,
				 false,
				 false,
	...
	protected void addRunningNormallyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DirectedRelationship_RunningNormally_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedRelationship_RunningNormally_feature", "_UI_DirectedRelationship_type"),
				 Component_Package.Literals.DIRECTED_RELATIONSHIP__RUNNING_NORMALLY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addRunningAbnormallyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DirectedRelationship_RunningAbnormally_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedRelationship_RunningAbnormally_feature", "_UI_DirectedRelationship_type"),
				 Component_Package.Literals.DIRECTED_RELATIONSHIP__RUNNING_ABNORMALLY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addToBePredictedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DirectedRelationship_ToBePredicted_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedRelationship_ToBePredicted_feature", "_UI_DirectedRelationship_type"),
				 Component_Package.Literals.DIRECTED_RELATIONSHIP__TO_BE_PREDICTED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
