...
/**
 * This is the item provider adapter for a {@link component.UtilityNodes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UtilityNodesItemProvider extends ComponentAssetItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UtilityNodesItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((UtilityNodes)object).getGid();
		return label == null || label.length() == 0 ?
			getString("_UI_UtilityNodes_type") :
			getString("_UI_UtilityNodes_type") + " " + label;
	}
