 ...
 *   <li>{@link artifact.impl.ArtifactPackageImpl#getInterfaces <em>Interfaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtifactPackageImpl extends ArtifactElementImpl implements ArtifactPackage {
	 ...
	 * @ordered
	 */
	protected EList<ArtifactPackageInterface> interfaces;
	 ...
	 */
	@Override
	public EList<ArtifactPackageInterface> getInterfaces() {
		if (interfaces == null) {
			interfaces = new EObjectResolvingEList<ArtifactPackageInterface>(ArtifactPackageInterface.class, this, Artifact_Package.ARTIFACT_PACKAGE__INTERFACES);
		}
		return interfaces;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Artifact_Package.ARTIFACT_PACKAGE__INTERFACES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Artifact_Package.ARTIFACT_PACKAGE__INTERFACES:
				getInterfaces().clear();
				getInterfaces().addAll((Collection<? extends ArtifactPackageInterface>)newValue);
				return;
		}
